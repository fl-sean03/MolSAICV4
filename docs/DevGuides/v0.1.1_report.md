...
**Primary spec:** [`DevGuide_v0.1.1.md`](docs/DevGuides/DevGuide_v0.1.1.md:1)  
...
Key outcomes per [`DevGuide_v0.1.1.md`](docs/DevGuides/DevGuide_v0.1.1.md:1):
...
- **External wrapper contract** is hardened and test-validated:
  - Contract: [`ADAPTER_CONTRACT.md`](docs/ADAPTER_CONTRACT.md:1)  
...
**Spec driver:** [`DevGuide_v0.1.1.md`](docs/DevGuides/DevGuide_v0.1.1.md:76) (Scope boundaries + canonicalization rules)
...
**Spec driver:** UPM thrusts in [`DevGuide_v0.1.1.md`](docs/DevGuides/DevGuide_v0.1.1.md:195)
...
**Files:**
- Contract: [`docs/ADAPTER_CONTRACT.md`](docs/ADAPTER_CONTRACT.md:1)
- Envelope + helpers:
  - [`ExternalToolResult`](src/external/adapter.py:51)
  - [`get_tool_version()`](src/external/adapter.py:125)
  - Missing tool semantics referenced in contract: [`Deterministic result persistence`](docs/ADAPTER_CONTRACT.md:37)
- Wrapper:
...
- Requirements derivation belongs in USM because it is topology-derived and UPM-independent: [`Scope boundaries`](docs/DevGuides/DevGuide_v0.1.1.md:74)
...
Per [`DevGuide_v0.1.1.md`](docs/DevGuides/DevGuide_v0.1.1.md:492), the following are intentionally deferred:
...
Primary spec reference: [`DevGuide_v0.1.1.md`](docs/DevGuides/DevGuide_v0.1.1.md:1)